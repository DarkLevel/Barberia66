...
moduleTipoproducto.controller('tipoproductoPlistController',  ['$scope', '$http', '$location', 'toolService', '$routeParams', '$anchorScroll',
    function ($scope, $http, $location, toolService, $routeParams, $anchorScroll) {
        ...
        $http({
            method: 'GET',
            url: 'http://localhost:8081/barberia66/barberia66?ob=tipoproducto&op=getcount'
        ...
        $http({
            method: 'GET',
            url: 'http://localhost:8081/barberia66/barberia66?ob=tipoproducto&op=getpage&rpp=' + $scope.rpp + '&page=' + $scope.page + $scope.orderURLServidor
        }).then(function (response) {
            $scope.status = response.status;
