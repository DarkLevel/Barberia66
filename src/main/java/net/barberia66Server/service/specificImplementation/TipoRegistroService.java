 ...
 * @author a073597589g
 */
public class TipoRegistroService extends GenericServiceImplementation implements ServiceInterface {
    
    public TipoRegistroService(HttpServletRequest oRequest) {
        super(oRequest);
